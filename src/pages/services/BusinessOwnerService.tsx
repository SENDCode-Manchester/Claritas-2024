...
export function BusinessOwnerService() {
  return (
    <>
      ...
      <Container>
        <Header><Bold>We work with lots of business owners and are familiar with the issues you may be facing.</Bold></Header>
        <Header>You're likely to be –</Header>
        <ul>
          <ListItem><Bold>Extremely busy running your business and looking for someone to simplify and make sense of your financial life.</Bold></ListItem>
        ...
        <ul>
          ...
          <ListItem><Bold>Work out how your business fits into your financial plan.</Bold> If you're looking to sell, how much do you need to sell for and what are your options for exit and/or succession planning?</ListItem>
